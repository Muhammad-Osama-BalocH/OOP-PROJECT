...
const programStart = async (persons: Person) => {
    ...
    console.log(chalk.cyan.bold("║                                                      ║"));
    console.log(chalk.cyan.bold("║        ") + chalk.bgBlue.bold("Welcome to Object Oriented Programming") + chalk.cyan.bold("        ║"));
    console.log(chalk.cyan.bold("║                     ") + chalk.blue.bold("Project") + chalk.cyan.bold("                          ║"));
    console.log(chalk.cyan.bold("║                                                      ║"));
    console.log(chalk.cyan.bold("╚════════════════════════════════════════════════════╝"));
